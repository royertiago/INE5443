...
"    before creating the dendogram.\n"
"    Note this will alter the dataset generated by the analysis.\n"
"\n"
"--standardize\n"
"    Rewrite the dataset entries in terms of standard deviations from the mean\n"
"    before creating the dengoram.\n"
"    (We assume every attribute has a normal distribution.)\n"
"    Note this will alter the dataset generated by the analysis.\n"
"\n"
"--width <N>\n"
"--height <N>\n"
...
namespace command_line {
    ...
    void parse( cmdline::args&& args ) {
        ...
        if( normalize && standardize ) {
            std::cerr << "It makes no sense to use both --normalize and --standardize.\n";
            std::exit(1);
        }
    }
} // namespace command_line
...
int main( int argc, char ** argv ) {
    ...
    if( command_line::normalize )
        dataset.normalize(0.0);
    if( command_line::standardize )
        dataset.standardize();
